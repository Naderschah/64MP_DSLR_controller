...
class Ui_Viewfinder(object):
    def setupUi(self, Viewfinder):
        ...
        self.HDR_check = QtWidgets.QCheckBox(self.verticalLayoutWidget)
        self.HDR_check.setObjectName("HDR_check")
        self.Button_row.addWidget(self.HDR_check)
        ...
        self.Button_row.addItem(spacerItem5)
    ...
    def retranslateUi(self, Viewfinder):
        ...
        self.HDR_check.setText(_translate("Viewfinder", "HDR"))
